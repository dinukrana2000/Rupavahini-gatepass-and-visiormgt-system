...
function Visit1() {
  ...
  const [formData, setFormData] = useState({
    requesterName : location.state.requesterName,
    requesteremail : location.state.requesteremail,
    requesterNIC : location.state.requesterNIC,
    requesterPhoneno : location.state.requesterPhoneno,
    officerName : location.state.officerName,
    appoinmentReason : location.state.appoinmentReason,
    appoinmentDate: location.state.appoinmentDate,
    appoinmentTime: location.state.appoinmentTime,
  });

        const appointmentTime = moment(location.state.appoinmentTime, 'h:mm A');
