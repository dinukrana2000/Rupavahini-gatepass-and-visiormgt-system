...
const Request = () => {
  ...
  const handleEdit = (request, type) => {
    if (type === 'visit') {
      navigate("./Formv", { state: request });
    }
    else{
      navigate("./FormA", { state: request });
    }
  };
    ...
    const fetchData = async () => {
      try {
        ...
        const appointmentResponse = await axios.get(
          "http://localhost:4000/appointmentreq/:username"
        );
        setAppoinmentRequests(appointmentResponse.data);
      } catch (error) {
                  ...
                  <Grid container xs={12} className="rectangle" spacing={0}>
                    <Grid item xs={5}>
                      <div className="request">
                        {request.dateofArrival.split("T")[0]} {request.timeslot}{" "}
                        {request.category}
                      </div>
                    </Grid>
                  ...
                  <div className="report">
                    ...
                    <div className="report-item">
                      ...
                      <span className="value">
                        {request.dateofArrival.split("T")[0]}
                      </span>
                    </div>
                    <div className="report-item">
