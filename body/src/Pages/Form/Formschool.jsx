...
function Form() {
    ...
    const [formData, setFormData] = useState({
        schoolname: location.state.category,
        grade: location.state.grade,
        address: location.state.address,
        Rname: location.state.name,
        designation: location.state.designation,
        email: '',
        cnumber: location.state.phoneNo,
        Mstudent: location.state.noOfmale,
        Fstudent: location.state.noOffemale,
        noteachers: location.state.noOfteachers,
        noparents:location.state.noOfparents,
    });
